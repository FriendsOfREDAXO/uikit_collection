...
if (isset($this->params['warning_messages'][$this->getId()]) && !$this->params['hide_field_warning_messages']) {
    $notices[] = '<span class="uk-text-danger">' . rex_i18n::translate($this->params['warning_messages'][$this->getId()]) . '</span>';
}
...
if (false !== $pos) {
    $attributes = $this->getAttributeElements([
        'class' => trim('uk-select ' . ($this->getWarningClass() ? 'uk-form-danger' : '')),
...
echo '
    <div class="' . $class_group . '" id="' . $this->getHTMLId() . '">
        ...
        <div class="uk-form-controls uk-grid-small uk-child-width-auto" uk-grid>' . $output . '</div>' 
        . $notice . '
    </div>
';
